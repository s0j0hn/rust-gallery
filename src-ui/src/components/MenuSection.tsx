...
import { Database, FileText, FolderOpen, Info, RefreshCw, Settings, Tag } from 'lucide-react'
...
const MenuSection: FC<MenuSectionProps> = ({
  ...
  const totalPhotos = roots.reduce((total, folder) => total + folder.photo_count, 0)
  ...
  return (
    <div className="mb-16 menu-section" data-open={menuOpen ? 'true' : 'false'}>
            ...
            <div>
              ...
              <ul className="space-y-1">
                <li className="flex items-center">
                  ...
                  Total Albums: <span className="font-medium ml-2">{folders.length}</span>
                </li>
                <li className="flex items-center">
                  <span className="mr-2">•</span>
                ...
                <li className="flex items-center">
                  <span className="mr-2">•</span>
                  Total Roots: <span className="font-medium ml-2">{roots.length}</span>
                </li>
                <li className="flex items-center">
                  <span className="mr-2">•</span>
                  Total Tags: <span className="font-medium ml-2">{allTags.length}</span>
                </li>
              </ul>
            </div>
      ...
      {/* Cache Manager Modal */}
      {showCacheManager && <CacheManager onClose={() => setShowCacheManager(false)} />}
