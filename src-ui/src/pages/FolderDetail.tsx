...
const FolderDetail: FC = () => {
  ...
  const loadMorePhotos = async () => {
    ...
    setLoading(true)
    try {
      const data = await api.photos.getAllByFolder(folderName, perPage, page)
  ...
  useEffect(() => {
    ...
    api.folders
      ...
      .catch((err) => console.error('Failed to fetch folder details:', err))
